 ...
 * @version    $Id: AdminIndexController.php 2020-01-17 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */

class Ememsub_AdminIndexController extends Core_Controller_Action_Admin
{
  public function indexAction()
  {
    
    $this->view->navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('ememsub_admin_main', array(), 'ememsub_admin_main_trans');
    // Test curl support
