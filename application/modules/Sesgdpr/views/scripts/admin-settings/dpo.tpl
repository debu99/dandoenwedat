 ...
 * @version    $Id: dpo.tpl 2018-05-19 00:00:00 SocialEngineSolutions $
...
<h3><?php echo $this->translate("Data Protection Officer Requests") ?></h3>
<p><?php echo $this->translate('This page lists all the special requests made by the users of your website concerning their personal data to your Data Protection Officer. You can enter the email for your DPO and other configuration below.  You can take action on their requests from below.'); ?></p>
<br />

<div class="settings sesbasic_admin_form">
	<?php echo $this->formEmail->render($this) ?>
</div>
<br />
...
<?php if( count($this->paginator) ): ?>
  <div class="sesbasic_search_reasult">
    <?php echo $this->translate(array('%s dpo request found.', '%s dpo requests found.', $counter), $this->locale()->toNumber($counter)) ?>
  </div>
    ...
    <table class='admin_table'>
      <thead>
        <tr>
          ...
          <th><a href="javascript:void(0);" ><?php echo $this->translate("Message") ?></a></th>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php echo  Engine_String::strlen($item->message) > 20 ? Engine_String::substr($item->message, 0, 20) . '...' : $item->message; ?></td>
...
<?php else:?>
  <div class="tip">
    <span>
      <?php echo $this->translate("There are no DPO requests made by your members yet.") ?>
    </span>
  </div>
<?php endif; ?>