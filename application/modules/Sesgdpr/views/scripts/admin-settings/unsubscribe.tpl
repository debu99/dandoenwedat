 ...
 * @version    $Id: unsubscribe.tpl 2018-05-19 00:00:00 SocialEngineSolutions $
...
<h3><?php echo $this->translate('Unsubscribe Requests') ?></h3>
<p><?php echo $this->translate('This page lists all the requests made by the users of your website asking to Unsubscribe them from all the email services. If the user is also added to any other marketing, advertising email list or any other email list, then you should also unsubscribe the user from those as well. You can take action on their requests from below.'); ?></p>
<br />
...
<?php if( count($this->paginator) ): ?>
  <div class="sesbasic_search_reasult">
    <?php echo $this->translate(array('%s unsubscribe request found.', '%s unsubscribe requests found.', $counter), $this->locale()->toNumber($counter)) ?>
  </div>
...
<?php else:?>
  <div class="tip">
    <span>
      <?php echo $this->translate("There are no unsubscription requests made by your members yet.") ?>
    </span>
  </div>
<?php endif; ?>