 ...
 * @version    $Id: success-access.tpl 2018-05-19 00:00:00 SocialEngineSolutions $
...
<h3><?php echo $this->translate('Subject Access Requests') ?></h3>
<p><?php echo $this->translate('This page lists all the subject access requests made by the users of your website concerning their personal data you possess. You can take action on their requests from below.'); ?></p>
<br />
...
<?php if( count($this->paginator) ): ?>
  <div class="sesbasic_search_reasult">
    <?php echo $this->translate(array('%s subject access request found.', '%s subjects access requests found.', $counter), $this->locale()->toNumber($counter)) ?>
  </div>
...
<?php else:?>
  <div class="tip">
    <span>
      <?php echo $this->translate("There are no subject access requests made by your members yet.") ?>
    </span>
  </div>
<?php endif; ?>