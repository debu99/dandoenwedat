 ...
 * @version    $Id: AdminContentController.php  2018-11-24 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sespwa_AdminContentController extends Core_Controller_Action_Admin
{
  public function indexAction()
  {
    $this->view->navigation = $navigation = Engine_Api::_()->getApi('menus', 'core')->getNavigation('sespwa_admin_main', array(), 'sespwa_admin_main_managetemplates');
    ...
    // Make page form
    $this->view->pageForm = $pageForm = new Sespwa_Form_Admin_Layout_Content_Page();
  ...
  public function saveAction()
  {
    ...
    $form = new Sespwa_Form_Admin_Layout_Content_Page();
    if( !$pageObject->custom ) {
