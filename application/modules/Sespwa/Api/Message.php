 ...
 * @version    $Id: Message.php  2018-11-24 00:00:00 SocialEngineSolutions $
 * @author     SocialEngineSolutions
 */

class Sespwa_Api_Message extends Core_Api_Abstract
{
  ...
  public function setUnreadMessage(Core_Model_Item_Abstract $user) {
    $userLastNotification = Engine_Api::_()->getApi('message', 'sespwa')->getUserLastMessage($user);
