 ...
 * @version    $Id: friendship-requests.tpl  2018-11-24 00:00:00 SocialEngineSolutions $
...
<?php if(count($this->peopleyoumayknow) > 0): ?>
  <div class="sespwa_pulldown_header"><?php echo $this->translate("People You May Know"); ?></div>
...
<script type="text/javascript">
  ...
  function redirectPage(event) {
    ...
    if(current_link.get('href') == null && $(current_link).get('tag')!='img') {
      ...
      new Request.JSON({
        url : en4.core.baseUrl + 'sespwa/notifications/markreadmention',
        data : {
          format     : 'json',
