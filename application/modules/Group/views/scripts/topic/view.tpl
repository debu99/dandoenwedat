          ...
          if( $isOwner ) {
            ...
            <div class="group_discussions_thread_info">
              ...
              <div class="group_discussions_thread_body">
                <?php echo nl2br($this->BBCode(Engine_Api::_()->core()->smileyToEmoticons($post->body), array('link_no_preparse' => true))) ?>
              </div>
              <span class="group_discussions_thread_body_raw" style="display: none;">
        <?php echo Engine_Api::_()->core()->smileyToEmoticons($post->body); ?>
      </span>
            </div>
          </li>
          <?php endforeach; ?>
